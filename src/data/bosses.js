...
export const BOSSES = {
  dread: {
    ...
    hp: 6500, r: 62, speed: 86, color: '#ff6b8a',
  ...
  prime: {
    ...
    hp: 11200, r: 56, speed: 210, color: '#ffb14a',
  ...
  eye: {
    ...
    hp: 15500, r: 54, speed: 58, color: '#7ee8ff',
  ...
  gravedigger: {
    ...
    hp: 25000, r: 60, speed: 92, color: '#5ef0d0',
  ...
  conduit: {
    ...
    hp: 34000, r: 52, speed: 104, color: '#7ee8ff',
  ...
  hive: {
    ...
    hp: 47000, r: 58, speed: 70, color: '#e879f9',
  ...
  distortion: {
    ...
    hp: 70000, r: 50, speed: 150, color: '#b06bff',
